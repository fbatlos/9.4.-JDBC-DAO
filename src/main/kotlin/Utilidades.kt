...
class Utilidades {
    ...
    companion object {
         ...
         */
        fun preguntarJugadores(consola: IOutputiinfo) : Int {
            return consola.leerEntero("Introduzca el número de jugadores (1-3): ", 1, 3)
        }

        /**
         * Solicita al usuario el número de cartones por jugador.
         *
         * @param consola Interfaz de entrada/salida para comunicarse con el usuario.
         * @return El número de cartones por jugador.
         */
        fun preguntarCartones(consola: IOutputiinfo) : Int {
            return consola.leerEntero("Introduzca el número de cartones (1-2): ", 1, 2)
        }
